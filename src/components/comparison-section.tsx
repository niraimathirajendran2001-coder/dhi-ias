...
function ComparisonRow({
  ...
  return (
    ...
    >
      {/* Feature */}
      <td className="px-5 py-4 font-serif text-[15px] font-medium text-[#FAFAF7]">
        {item.feature}
      </td>
      ...
      <td className="px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <span className="font-sans text-[14px] text-[#FAFAF7]/40">
            {item.others}
          </span>
        </div>
      </td>
      ...
      <td className="px-5 py-4">
        <div className="flex items-center gap-3">
          ...
          <span className="font-sans text-[14px] font-medium text-[#E8B830]">
            {item.aristocrat}
          </span>
        </div>
      </td>
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{
          background: 'linear-gradient(160deg, #0F1F4B 0%, #1A2E6B 50%, #0F1F4B 100%)',
        }}
      />
      <div
        className="absolute inset-0 hidden dark:block"
        style={{
          background: 'linear-gradient(160deg, #0A1428 0%, #0D1525 50%, #0A1428 100%)',
        }}
      />
          ...
          >
            <table className="w-full">
              ...
              <thead>
                <tr
                  style={{
                    background: 'linear-gradient(90deg, rgba(200,150,12,0.15), rgba(232,184,48,0.2), rgba(200,150,12,0.15))',
                  }}
                >
                  <th className="px-5 py-4 text-left font-sans ui-label text-[11px] text-[#FAFAF7]/70">
                    Feature
                  </th>
                  <th className="px-5 py-4 text-left font-sans ui-label text-[11px] text-[#FAFAF7]/40">
                    Others
                  </th>
                  <th className="px-5 py-4 text-left font-sans ui-label text-[11px] text-[#E8B830]">
                    Aristocrat
                  </th>
                </tr>
              </thead>
